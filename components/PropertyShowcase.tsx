...
export const PropertyShowcase: React.FC<PropertyShowcaseProps> = ({ currency }) => {
  return (
        ...
        <div className="bg-white rounded-[3rem] shadow-2xl border border-gray-100 overflow-hidden max-w-6xl mx-auto">
          <div className="px-10 py-5 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
            ...
            <div className="hidden md:flex gap-8 text-[11px] font-black uppercase tracking-widest text-gray-400">
              <span className="text-gray-900 border-b-2 border-[#FF5A3D] pb-1">Listing</span>
              <span>Investment</span>
              <span>Services</span>
              <span>Contact</span>
            </div>
            <button className="bg-[#FF5A3D] text-white px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[#ff4624] transition-colors">
              Request Info
            </button>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              <div className="lg:col-span-8 space-y-4">
                <div className="relative aspect-[16/10] rounded-[2rem] overflow-hidden group">
                  <img src="https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&w=1200&q=80" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Luxury Home" />
                  <div className="absolute top-6 left-6 flex gap-3">
                    <span className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-[#FF5A3D] shadow-lg">For Sale</span>
                  </div>
                ...
                <div className="grid grid-cols-4 gap-4 h-32">
                  <img src="https://images.unsplash.com/photo-1512918766775-d56aebb309f3?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover rounded-2xl border-2 border-[#FF5A3D] cursor-pointer" alt="Interior 1" />
                  <img src="https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover rounded-2xl cursor-pointer hover:opacity-80 transition-opacity" alt="Interior 2" />
                  <img src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover rounded-2xl cursor-pointer hover:opacity-80 transition-opacity" alt="Kitchen" />
                  <div className="relative rounded-2xl overflow-hidden cursor-pointer group h-full">
                    <img src="https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover transition-transform group-hover:scale-110" alt="Bedroom" />
                 ...
                 <div className="bg-gray-50 rounded-[2.5rem] p-8 border border-gray-100 flex flex-col h-full shadow-inner">
                    ...
                    <div className="space-y-6 flex-1">
                      <div>
                        ...
                        <p className="text-4xl font-black text-[#FF5A3D]">{formatPrice(250000, currency)}</p>
                      </div>
                      ...
                      <div className="bg-white rounded-3xl p-5 border border-gray-200 flex items-center gap-4">
                         <div className="w-12 h-12 bg-orange-100 rounded-2xl flex items-center justify-center text-[#FF5A3D]">
                            <Calculator size={24} />
                         </div>
                         <div>
                    ...
                    <button className="w-full bg-gray-900 text-white py-5 rounded-2xl font-black uppercase text-[11px] tracking-[0.2em] shadow-xl hover:bg-black transition-all mt-10">
                      Start Your Purchase
                    </button>
                 </div>
              </div>
            ...
            <div className="mt-12 flex flex-col md:flex-row justify-between items-end gap-6">
              <div>
                ...
                <div className="flex items-center gap-2 text-gray-500 font-bold text-sm">
                  <MapPin size={16} className="text-[#FF5A3D]" /> 551 Joanne Lane, Wilmington, MA 01887
                </div>
              </div>
            </div>
          </div>
