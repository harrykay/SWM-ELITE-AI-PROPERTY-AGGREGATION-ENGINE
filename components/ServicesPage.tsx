        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          {services.map((service, idx) => (
            ...
            >
              ...
              <button className="mt-10 w-full py-4 border border-gray-100 dark:border-white/10 rounded-2xl text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 group-hover:bg-gray-900 dark:group-hover:bg-white group-hover:text-white dark:group-hover:text-black transition-all">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-8">
              <button className="bg-[#8DC63F] text-black px-10 md:px-16 py-4 md:py-6 rounded-2xl font-black uppercase text-[10px] md:text-xs tracking-[0.3em] hover:scale-105 transition-transform shadow-2xl shadow-[#8DC63F]/20">
                Get a Quote
              </button>
              <button className="bg-white/5 border border-white/10 text-white px-10 md:px-16 py-4 md:py-6 rounded-2xl font-black uppercase text-[10px] md:text-xs tracking-[0.3em] hover:bg-white/10 transition-all">
                View Project Node
              </button>
            </div>
          </div>
